...
def parse_option():
    ...
    parser.add_argument('--model_s', type=str, default='resnet8',
                        choices=['resneti50','resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110',
                                 'resnet8x4', 'resnet32x4', 'wrn_16_1', 'wrn_16_2', 'wrn_40_1', 'wrn_40_2',
                                 'vgg8', 'vgg11', 'vgg13', 'vgg16', 'vgg19', 'ResNet50',
                                 'MobileNetV2', 'ShuffleV1', 'ShuffleV2'])
    parser.add_argument('--path_t', type=str, default=None, help='teacher model snapshot')
    parser.add_argument('--path_config', type=str, default=None, help='student model path')
...
def main():
    ...
    #model_t = EfficientNet.from_pretrained('efficientnet-b0',weights_path = './pretrain_efficientNet/pretrain_efficientNet.pt')
